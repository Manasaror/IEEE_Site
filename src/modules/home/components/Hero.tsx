    ...
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
        ...
        <div className="flex items-center justify-center gap-4">
          <img src="/images/IeeeLogo.webp" alt="IEEE Logo" className="h-16 w-16 object-contain" />
        ...
        <div className="mt-14 animate-[fadeUp_1.6s_ease-out]">
          <p className="text-base tracking-widest text-white/60">INNOVATE • CONNECT • LEAD</p>
        </div>
      </div>
