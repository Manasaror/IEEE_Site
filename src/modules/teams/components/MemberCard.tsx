  ...
  return (
    <article
      ...
      className={`
        ...
        max-w-[620px] w-full
        rounded-2xl bg-[#0a2a4a] border-2 border-[#1a4a6a]
        shadow-[0_2px_12px_rgba(0,80,160,0.15)]
        overflow-hidden
        transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)]
        hover:border-[#006699]
        hover:shadow-[0_12px_40px_rgba(0,102,153,0.25)]
    ...
    >
      ...
      <div className="flex flex-col gap-1 min-w-0">
        <h3 className="m-0 text-xl max-sm:text-lg font-extrabold text-white leading-snug">
          {member.name}
        </h3>
        ...
        <p className="m-0 mt-2 text-[0.95rem] max-sm:text-sm text-white/70 leading-relaxed">
          {member.department}
        </p>
        ...
        >
          {member.socials &&
            (Object.keys(member.socials) as (keyof typeof socialConfig)[]).map((key) => {
              ...
              // Safety Guard: Valid URL & Supported Config
              ...
              return (
                <a
                  ...
                  onMouseEnter={(e) => {
                    ...
                    el.style.backgroundColor = config.hoverBg;
                    el.style.color = '#ffffff';
                  }}
                  onMouseLeave={(e) => {
                    const el = e.currentTarget;
                    el.style.backgroundColor = `${config.color}14`;
